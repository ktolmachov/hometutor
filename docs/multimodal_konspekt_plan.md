...
- `app/media_alignment.py` — post-hoc выравнивание `anchor-lis-v3.1`: (1) семантическая
  ...
  (7) `t_end` = начало следующего раздела прохода, у хвоста — конец смыслового блока (не
