"""Zero-LLM flashcards from konspekt «Важные термины и концепции» (role ``terms``).

Локальный шаблон конспекта форматирует термины как ``- **Термин** — определение.``
(см. ``section_index.section_role``). Парсинг детерминированный: карточка = то, что
дословно написал автор конспекта, никакого LLM-вызова и, следовательно, никаких
галлюцинаций в паре термин/определение.
"""
