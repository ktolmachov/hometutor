# Smart Demo — кадры сценариев

> В этом runtime-репозитории сохранена витрина demo-артефактов: GIF/PNG и `meta.json` лежат в `docs/screenshots/final/<scenario_id>/`. Исходные YAML-манифесты сценариев и генератор документа относятся к `hometutor-studio`, поэтому здесь документ можно править как актуальную runtime-витрину.

## О чём этот документ

Каждый сценарий здесь — это последовательность **реальных кадров** из Streamlit UI, снятых Playwright'ом в ходе demo-теста. Все 30 сценариев сняты в **offline-режиме** (`HOME_RAG_E2E_OFFLINE=1`): они доказывают работу UI-потоков, навигации и state-management, но **не демонстрируют качество LLM-генерации** (ответов, объяснений тьютора, quiz, flashcards). Показатели вроде «confidence 87 %» являются тестовыми фикстурами, а не реальными LLM-метриками.
...
Сценарии 21–22 раскрывают demo-путь Smart Study Router: **Умный Маршрутизатор сейчас** показывает один лучший следующий шаг с объяснением, а **Умный Маршрутизатор с ИИ** показывает AI Vision из 5 уровней поверх той же local-first логики.

![Smart Study Router: один лучший следующий шаг](screenshots/final/scenario_21/01_smart_study_router_card.png)

<sub>Существующие сценарии ниже сохранены как PR-витрина для внешнего просмотра.</sub>

## Quality gate

Для публикации демо считается готовым только сценарий со статусом `✅ полностью снят`: все ожидаемые PNG/GIF есть в `docs/screenshots/final/`, а рядом лежит `meta.json`. В этом runtime checkout нет `package.json` и npm demo-скриптов; если нужно переснять/пересобрать витрину, используйте pipeline из `hometutor-studio`, затем обновите артефакты здесь.
...
- [scenario_14 — Полный export/sync и восстановление](#scenario-14--полный-exportsync-и-восстановление) — ✅
...
<sub>файл: `docs/screenshots/final/scenario_01/demo.gif` · 785 KB</sub>
...
<sub>файл: `docs/screenshots/final/scenario_02/demo.gif` · 658 KB</sub>
...
<sub>файл: `docs/screenshots/final/scenario_03/demo.gif` · 735 KB</sub>
...
<sub>файл: `docs/screenshots/final/scenario_04/demo.gif` · 506 KB</sub>
...
<sub>файл: `docs/screenshots/final/scenario_05/demo.gif` · 529 KB</sub>
...
<sub>файл: `docs/screenshots/final/scenario_06/demo.gif` · 770 KB</sub>
...
<sub>файл: `docs/screenshots/final/scenario_07/demo.gif` · 614 KB</sub>
...
<sub>файл: `docs/screenshots/final/scenario_08/demo.gif` · 556 KB</sub>
...
<sub>файл: `docs/screenshots/final/scenario_09/demo.gif` · 763 KB</sub>
...
<sub>файл: `docs/screenshots/final/scenario_10/demo.gif` · 586 KB</sub>
...
<sub>файл: `docs/screenshots/final/scenario_11/demo.gif` · 284 KB</sub>
...
<sub>файл: `docs/screenshots/final/scenario_12/demo.gif` · 427 KB</sub>
...
<sub>файл: `docs/screenshots/final/scenario_13/demo.gif` · 875 KB</sub>
...
<sub>файл: `docs/screenshots/final/scenario_14/demo.gif` · 542 KB</sub>
...
<sub>файл: `docs/screenshots/final/scenario_15/demo.gif` · 435 KB</sub>
...
<sub>файл: `docs/screenshots/final/scenario_16/demo.gif` · 460 KB</sub>
...
<sub>файл: `docs/screenshots/final/scenario_17/demo.gif` · 543 KB</sub>
...
<sub>файл: `docs/screenshots/final/scenario_18/demo.gif` · 572 KB</sub>
...
<sub>файл: `docs/screenshots/final/scenario_19/demo.gif` · 395 KB</sub>
...
<sub>файл: `docs/screenshots/final/scenario_20/demo.gif` · 430 KB</sub>
...
**Зачем:** Показать killer-фичу: система не оставляет пользователя перед
...
<sub>файл: `docs/screenshots/final/scenario_21/demo.gif` · 404 KB</sub>
...
**Зачем:** Показать следующий эволюционный шаг SSR: текущий deterministic router остаётся
...
<sub>файл: `docs/screenshots/final/scenario_22/demo.gif` · 801 KB</sub>
...
<sub>файл: `docs/screenshots/final/scenario_23/demo.gif` · 404 KB</sub>
...
<sub>файл: `docs/screenshots/final/scenario_24/demo.gif` · 402 KB</sub>
...
<sub>файл: `docs/screenshots/final/scenario_25/demo.gif` · 597 KB</sub>
...
<sub>файл: `docs/screenshots/final/scenario_26/demo.gif` · 504 KB</sub>
...
<sub>файл: `docs/screenshots/final/scenario_27/demo.gif` · 577 KB</sub>
...
<sub>файл: `docs/screenshots/final/scenario_28/demo.gif` · 623 KB</sub>
...
<sub>файл: `docs/screenshots/final/scenario_29/demo.gif` · 442 KB</sub>
...
<sub>файл: `docs/screenshots/final/scenario_30/demo.gif` · 404 KB</sub>
...
---
_Артефакты сценариев сохранены в `docs/screenshots/final/`; исходные манифесты и генератор находятся в `hometutor-studio`._
