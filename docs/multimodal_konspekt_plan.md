...
- `app/media_alignment.py` — post-hoc выравнивание `anchor-lis-v3.3`: (1) семантическая
  ...
  латинских терминов конспекта в кириллицу ASR: «skills» ↔ «скиллс»); (3) локальная
  L1-синонимия учебных паттернов без LLM («практическое задание» ↔ «домашка/упражнение»);
  (4) slide-aware
  ...
  (7) synthetic meta-разделы и пустые structural parents не получают timestamp;
  ...
  проходами, границы блоков, инварианты `t_end`), `tests/test_media_section_matching.py`.
